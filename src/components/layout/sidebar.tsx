        ...
        <nav className="p-4 overflow-y-auto h-[calc(100%-65px)]">
          ...
          <ul className="space-y-2">
             <Accordion type="single" collapsible className="w-full">
              ...
              <li><Link href="/galeria-assinantes" className="block p-3 rounded-md hover:bg-muted text-violet-600 hover:text-violet-500 font-semibold flex items-center gap-2" onClick={onClose}>
